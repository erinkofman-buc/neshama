...
VENDORS = [
    ...
    },
    {
        'name': 'Kapara',
        'category': 'Middle Eastern & Israeli',
        'description': 'COR-certified Israeli restaurant in Thornhill. Casual, flavourful Middle Eastern food with catering options for shiva meals.',
        'address': '7700 Bathurst St, Unit 12, Thornhill, ON',
        'neighborhood': 'Thornhill',
        'phone': '(905) 886-0508',
        'website': 'https://kapara.ca',
        'kosher_status': 'COR',
        'delivery': 1,
        'delivery_area': 'Toronto,North York',
    },
