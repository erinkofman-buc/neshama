...
VENDORS = [
    ...
    {
        'name': 'Beyond Delish Kosher Food Catering',
        'category': 'Caterers',
        'description': 'COR-certified kosher caterer on Bathurst. Full-service catering from intimate gatherings to large events. Fresh ingredients, Lubavitch shechita available. A trusted choice for shiva meals and community events.',
        'address': '5987 Bathurst St, North York, ON M2R 1Z3',
        'neighborhood': 'North York',
        'phone': '',
        'website': 'https://www.beyonddelish.ca',
        'kosher_status': 'COR',
