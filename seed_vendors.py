...
MONTREAL_VENDORS = [
    ...
    },
    {
        'name': 'Moishes',
        'category': 'Restaurants & Delis',
        'description': "Legendary Montreal steakhouse and a fixture of the city's Jewish community since 1938. Famous for dry-aged steaks and old-school elegance on The Main (Boulevard Saint-Laurent).",
        'address': '3961 Boulevard Saint-Laurent, Montréal, QC',
        'neighborhood': 'Plateau Mont-Royal',
        'phone': '(514) 845-3509',
    ...
    },
    {
        ...
        'category': 'Restaurants & Delis',
        'description': "Chef Martin Picard's legendary Plateau restaurant known for bold Québécois cuisine. Offers catering, private events, and prepared foods through their cabane à sucre and épicerie.",
        'address': '536 Avenue Duluth Est, Montréal, QC',
        'neighborhood': 'Plateau Mont-Royal',
        'phone': '(514) 281-1114',
        'website': 'https://www.aupieddecochon.ca',
        'kosher_status': 'not_certified',
        'delivery': 0,
        'delivery_area': '',
    },
...
GIFT_VENDORS = [
    ...
    {
        'name': 'Lush',
        'category': 'Self-Care & Comfort',
        'description': 'Handmade bath bombs, soaps, and self-care gift sets. A thoughtful comfort gift for someone going through a difficult time. Multiple GTA locations plus online.',
        'address': 'Multiple GTA locations',
        'neighborhood': 'GTA',
        'phone': '',
        'website': 'https://www.lush.com/ca/en',
        'kosher_status': 'not_certified',
        'delivery': 1,
        'delivery_area': 'Canada-wide',
    },
    ...
    },
    {
        ...
        'category': 'Self-Care & Comfort',
        'description': 'Body care, candles, and comfort gift sets. Soothing lotions, aromatherapy, and home fragrance. A gentle, practical gift to bring comfort during mourning.',
        'address': 'Multiple GTA locations',
        'neighborhood': 'GTA',
        'phone': '',
    ...
    },
    {
        'name': 'Sephora',
        'category': 'Self-Care & Comfort',
        'description': 'Beauty and self-care gift sets. Skincare, fragrance, and wellness products. Gift cards available. A thoughtful way to encourage self-care during a difficult time.',
        'address': 'Multiple GTA locations',
        'neighborhood': 'GTA',
        'phone': '',
        'website': 'https://www.sephora.com/ca/en',
        'kosher_status': 'not_certified',
        'delivery': 1,
        'delivery_area': 'Canada-wide',
    },
