...
VENDORS = [
    ...
    },
    {
        'name': 'Pizza Cafe',
        'category': 'Italian',
        'description': 'Kosher pizza and Italian food. Pizza platters, pasta trays, and family-style meals. A reliable choice for casual shiva meals.',
        'address': 'Toronto, ON',
        'neighborhood': 'Toronto',
        'phone': '',
        'website': '',
    ...
    },
    {
        ...
        'address': 'Bathurst St area, Toronto, ON',
        'neighborhood': 'Bathurst Manor',
        'phone': '',
        'website': '',
        'kosher_status': 'COR',
    ...
    },
    {
        ...
        'category': 'Bagel Shops & Bakeries',
        'description': 'Classic kosher bakery on Bathurst. Known for hamantaschen, pastries, and traditional Jewish baked goods. A neighbourhood staple.',
    ...
    },
    {
        'name': 'Kapara',
        'category': 'Middle Eastern & Israeli',
        'description': 'COR-certified Israeli restaurant on Bathurst. Casual, flavourful Middle Eastern food with catering options for shiva meals.',
    ...
    },
    {
        ...
        'category': 'Kosher Restaurants & Caterers',
        'description': 'COR-certified kosher Asian restaurant on the Bathurst corridor. Chinese dishes, fried rice, and Asian comfort food.',
        'address': 'Bathurst St, Toronto, ON',
        'neighborhood': 'Bathurst Manor',
        'phone': '',
        'website': '',
    ...
    },
    {
        'name': 'Shalom India',
        'category': 'Kosher Restaurants & Caterers',
        'description': 'COR-certified kosher Indian restaurant in Toronto. Curries, tandoori, biryani, and vegetarian options — a unique and flavourful choice for shiva meals.',
        'address': 'Toronto, ON',
        'neighborhood': 'Toronto',
        'phone': '',
        'website': '',
...
MONTREAL_VENDORS = [
    ...
    {
        'name': 'Eden Hall Kosher Caterer',
        'category': 'Caterers',
        'description': 'MK-certified kosher caterer with a banquet hall in the West Island (DDO). Custom menus for weddings, anniversaries, corporate events, shiva meals, and private receptions.',
        'address': '96 Fredmir, Dollard-des-Ormeaux, QC',
        'neighborhood': 'Dollard-des-Ormeaux',
        'phone': '(514) 542-1818',
        'website': 'http://edenhallreceptions.com',
        'kosher_status': 'MK',
        'delivery': 1,
        'delivery_area': 'Montreal,Dollard-des-Ormeaux,Côte-Saint-Luc',
    },
    {
        'name': 'Mehadrin Meats',
        'category': 'Kosher Restaurants & Caterers',
