...
class NeshamaAPIHandler(BaseHTTPRequestHandler):
    ...
    STATIC_FILES = {
        ...
        '/shiva-catering': ('shiva-catering.html', 'text/html'),
        '/shiva-catering.html': ('shiva-catering.html', 'text/html'),
        '/shiva-caterers-toronto': ('shiva-catering.html', 'text/html'),
        '/shiva-caterers-montreal': ('shiva-catering.html', 'text/html'),
